...
"C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe" -NoProfile -ExecutionPolicy Bypass -File "C:\Users\User\logistics-api\start.ps1" >> "C:\Users\User\logistics-api\heartbeat-debug.log" 2>&1
