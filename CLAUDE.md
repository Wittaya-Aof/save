...
## ยังไม่แก้ (ตั้งใจ)
- ~~pinwheel / tail rotation สำหรับพาเลท~~ **ทำแล้ว** (2026-07-31 รอบ A+B) — ได้ 9 ใบใน 20'GP
  และเพิ่มในรถ 18/10/6 ล้อด้วย รวม 7/30 คู่ · ดูหัวข้อ "เพิ่มความจุพาเลท A+B" ด้านบน
...
- **การหมุนพาเลทแบบ pinwheel เต็มรูป** — ตอนนี้ทำแค่ "โซน grid ทิศเดียว + ใบท้ายตู้หันขวาง"
  ยังไม่ลองสลับทิศแบบ interlock ทั้งตู้ · ทำเพิ่มได้แต่ต้องมีเคสจริงยืนยันว่าหน้างานวางตามได้
